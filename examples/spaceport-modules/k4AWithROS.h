...
private:
    ...
    void createCameraInfoDepth(k4a_calibration_t depth_params)
        ...
        createCameraInfo(size_ir_, camera_matrix_depth, distortion_matrix_depth, cv::Mat::eye(3, 3, CV_64F), 
	...
	void createCameraInfoIR(k4a_calibration_t ir_params)
	{
		...
		createCameraInfo(size_depth_, camera_matrix_ir, distortion_matrix_ir, cv::Mat::eye(3, 3, CV_64F), 
	...
	depth_info_pub_, color_pubCompressed_, color_info_pub_,
	xy_table_pubCompressed_;
    ...
    std_msgs::Header header_depth_, header_ir_, header_color_, header_xy_table;
	...
	sensor_msgs::CompressedImage xy_table_imageCompressed;
