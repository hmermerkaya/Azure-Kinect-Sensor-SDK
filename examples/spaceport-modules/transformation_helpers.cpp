                                             ...
                                             const std::string &file_name)
{
   ...
   std::vector<color_point_t> points;
    ...
    for (int i = 0; i < width * height; i++)
    {
        ...
        cloud.points[i].x=  point_cloud_image_data[3 * i + 0]/1000.f;
        cloud.points[i].y=  point_cloud_image_data[3 * i + 1]/1000.f;
        cloud.points[i].z=  point_cloud_image_data[3 * i + 2]/1000.f;
        
        cloud.points[i].b=color_image_data[4 * i + 0];
        cloud.points[i].g=color_image_data[4 * i + 1];
        cloud.points[i].r=color_image_data[4 * i + 2];

    //   std::cout<<"cloud.points[i].x "<<cloud.points[i].x<<std::endl;
    ...
    std::string filename=file_name+".pcd";
