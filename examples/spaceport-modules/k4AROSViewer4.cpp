...
private:
	...
	std::string frame_id1, frame_id2, frame_id3, frame_id4, time_stamp1, time_stamp2;
	cv::Mat color1, ir1, color2, ir2, color3, ir3, color4, ir4;
...
//        imshow("",color1);
	...
	cv::imwrite(frame_id4 + "-" + tmstp + "-rgb.png", color4, params);
